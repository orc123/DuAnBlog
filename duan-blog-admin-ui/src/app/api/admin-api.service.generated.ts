...
export class AdminApiPostApiClient {
     ...
     * @return OK
     */
    getPostsPaging(keyword?: string | null | undefined, categoryId?: string | null | undefined, pageIndex?: number | null | undefined, pageSize?: number | null | undefined): Observable<PostInListDtoPagedResult> {
     ...
     * @return OK
     */
    getSeriesBelong(postId: string | null): Observable<SeriesInListDto[]> {
     ...
     * @return OK
     */
    getReason(id: string | null): Observable<string> {
...
export class AdminApiPostCategoryApiClient {
     ...
     * @return OK
     */
    getPostCategoriesByPaging(keywork?: string | null | undefined, pageIndex?: number | null | undefined, pageSize?: number | null | undefined): Observable<PostCategoryDtoPagedResult> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPostCategoriesByPaging(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPostCategoriesByPaging(response_ as any);
                } catch (e) {
    ...
    protected processGetPostCategoriesByPaging(response: HttpResponseBase): Observable<PostCategoryDtoPagedResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AdminApiRoleApiClient {
     ...
     * @return OK
     */
    updateRolePermissions(body?: PermissionDto | undefined): Observable<void> {
...
export class AdminApiSeriesApiClient {
     ...
     * @return OK
     */
    updateSeries(id?: string | null | undefined, body?: CreateUpdateSeriesRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/series?";
        if (id !== undefined && id !== null)
     ...
     * @return OK
     */
    getPostsInSeries(seriesId: string | null): Observable<PostInListDto[]> {
     ...
     * @return OK
     */
    getSeriesPaging(keyword?: string | null | undefined, pageIndex?: number | null | undefined, pageSize?: number | null | undefined): Observable<SeriesInListDtoPagedResult> {
...
export class AdminApiUserApiClient {
     ...
     * @return OK
     */
    getAllUsersPaging(keyword?: string | null | undefined, pageIndex?: number | null | undefined, pageSize?: number | null | undefined): Observable<UserDtoPagedResult> {
