...
[ApiController]
public class MediaController(IWebHostEnvironment env, IOptions<MediaSettings> settings) : ControllerBase
{
    private readonly IWebHostEnvironment _hostingEnv = env;
